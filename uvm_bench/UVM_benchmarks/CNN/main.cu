...
static inline void loaddata() {
  mnist_load("/shared/uvm_bench/UVM_benchmarks/CNN/data/train-images.idx3-ubyte", "/shared/uvm_bench/UVM_benchmarks/CNN/data/train-labels.idx1-ubyte",
             &train_set, &train_cnt);
  mnist_load("/shared/uvm_bench/UVM_benchmarks/CNN/data/t10k-images.idx3-ubyte", "/shared/uvm_bench/UVM_benchmarks/CNN/data/t10k-labels.idx1-ubyte",
             &test_set, &test_cnt);
...
static void learn() {
  ...
  // printf("save to file\n");
  // FILE * fp = fopen("/shared/uvm_bench/log/cnn-uvm.txt", "a");
  // if (fp == NULL) {
