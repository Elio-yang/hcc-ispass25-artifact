...
if __name__ == '__main__':
    ...
    parser.add_argument('-fp16i', action='store_true', default=False, help='use fp16 input to test')
    ...
    my_logfile_name = args.net+"-"+compute_mode+"-e"+str(settings.EPOCH)+"-b"+str(cifar100_test_loader.batch_size)+"_fp16_test_throughputs.csv"
